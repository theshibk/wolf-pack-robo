...
const std::string RoleWolf::NAME( "Wolf" );
...
bool
RoleWolf::execute( PlayerAgent * agent )
{
...
*/
void
RoleWolf::doKick( PlayerAgent * agent )
{
...
*/
void
RoleWolf::doMove( PlayerAgent * agent )
{
