...
private:
    ...
    std::string M_record_stats_file; // path to file to write stats to
...
public:
    ...
    /*!
      \brief get the record stats file
      \return the record stats file
     */
    const std::string & recordStatsFile() const { return M_record_stats_file; }
};
